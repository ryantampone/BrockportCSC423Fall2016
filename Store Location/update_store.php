...
function update_store()
{
  // Connect to the 'test' database
	...
	$sql_stmt = "UPDATE RetailStore SET StoreCode='$storecode', StoreName='$storename', Address='$address', City='$city', State='$state', ZIP='$zip', Phone='$phone', ManagerName='$mgrname' WHERE StoreId='$storeid';";
